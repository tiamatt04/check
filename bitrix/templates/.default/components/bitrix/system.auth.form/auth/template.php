...
<?if($arResult["FORM_TYPE"] == "login"):?>
    ...
    <span class="hd_singin"><a id="hd_singin_but_open" href="" style="text-decoration: none;">Войти на сайт</a>
...
<p><span class="hd_close_loginform">Закрыть</span></p>
</div>
</span><br>

    <?if($arResult["NEW_USER_REGISTRATION"] == "Y"):?>
        <noindex><a href="<?=$arResult["AUTH_REGISTER_URL"]?>" class="hd_signup" rel="nofollow" style="text-decoration: none;"><?=GetMessage("AUTH_REGISTER")?></a></noindex>
    <?endif?>
